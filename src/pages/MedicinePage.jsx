...
import { ArrowLeft, Pill, Bell, Plus, ExternalLink, Search, CheckCircle2, XCircle, Info, Loader, Trash2, Clock, CalendarRange, AlertTriangle } from 'lucide-react';
...
const MedicinePage = () => {
  ...
  const handleSearchFDA = async (e) => {
    ...
    try {
      ...
      if (data.results && data.results.length > 0) {
        ...
        const purpose = result.purpose ? result.purpose[0] : (result.indications_and_usage ? result.indications_and_usage[0] : 'Unknown purpose');
        ...
        const cleanText = (text) => text.substring(0, 150).replace(/^[A-Z\s]+:/, '') + '...';
  ...
  return (
    <div className="pb-24 px-5 pt-6 w-full max-w-screen-md mx-auto relative">
